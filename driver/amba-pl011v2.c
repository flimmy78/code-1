...
#define hanbang_read(a)  (*(volatile unsigned int*)IO_ADDRESS(a))
#define hanbang_write(v,a) (*(volatile unsigned int*)IO_ADDRESS(a) = (v))

#define GPIO2_BASE     0x20160000
#define GPIOX_DIR      0x400
#define GPIO_TARGET    0x10
...
/* Hanbang : FIFO be enough for HB761 */
static struct vendor_data vendor_arm = {
//	.ifls			= UART011_IFLS_RX4_8|UART011_IFLS_TX4_8,
	.ifls			= UART011_IFLS_RX7_8|UART011_IFLS_TX4_8,
	.fifosize		= 16,
	...
	if (status) {
		do {
			...
			if (status & UART011_TXIS){
				hanbang_write(0xff, (GPIO2_BASE + (GPIO_TARGET << 2)));
				pl011_tx_chars(uap);
				while ((readw(uap->port.membase + UART01x_FR) & UART011_FR_TXFE) != UART011_FR_TXFE);
				hanbang_write(0, (GPIO2_BASE + (GPIO_TARGET << 2)));
...
static int pl011_probe(struct amba_device *dev, const struct amba_id *id)
{
	...
	hanbang_write(GPIO_TARGET, GPIO2_BASE + GPIOX_DIR);
