...
#define CONFIG_STACKSIZE_IRQ        128
...
#define CONFIG_NETMASK	255.0.0.0		/* talk on MY local net */
#define CONFIG_IPADDR	10.0.0.2		/* default static IP */
#define CONFIG_SERVERIP	10.0.0.1		/* default tftp server ip */
